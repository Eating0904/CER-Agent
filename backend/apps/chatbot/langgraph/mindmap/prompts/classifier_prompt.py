...
- **觸發情境**: 學生詢問關於 SDGs 議題、CER 架構定義、論點發想、證據引用、寫作邏輯或英文理解的問題。這代表學生在「知識」或「思考」上卡住了，需要老師角色的協助。
- **關鍵字範例**: "什麼是 CER?"， "這篇文章的重點是什麼?"， "我找不到證據"， "這個論點好嗎?"， "SDG 13 是什麼?"，"這句英文是甚麼意思?"

### 3. cer_scoring (CER 評分請求)
- **觸發情境**: 學生請求對其心智圖進行 CER 評分，想了解其主張 (Claim)、證據 (Evidence)、推理 (Reasoning) 的表現如何。
