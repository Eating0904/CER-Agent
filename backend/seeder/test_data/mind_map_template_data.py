...
TEMPLATES = [
    ...
    # Teacher B Templates
    {
        ...
        'issue_topic': 'Is full-scale remote work more beneficial than harmful?',
        'article_content': 'In the post-pandemic era, many companies have retained hybrid or fully remote work models. Supporters argue that remote work reduces commuting time, allows employees more flexibility in scheduling, and improves job satisfaction and quality of life. Opponents, however, point out that the lack of physical interaction may reduce team cohesion, and working from home is more prone to disruptions, ultimately impacting efficiency. Finding a balance between flexibility and management has become a crucial challenge for companies in the post-pandemic era.',
        'start_date': START_DATE,
        'end_date': END_DATE,
    },
    {
        ...
        'issue_topic': 'Does the use of social media have a negative impact on the mental health of teenagers?',
        'article_content': "Social media has become an important part of teenagers' social lives. Studies show that excessive use of social media may lead to problems such as anxiety, depression, and body ego, because people tend to present a positive image online, creating a comparative mindset. However, social media also provides a platform for peer support and self-expression. The key lies in guiding teenagers to develop healthy usage habits and improving their media literacy.",
        'start_date': START_DATE,
        'end_date': END_DATE,
    },
    # Teacher C Templates
    {
        'created_by': 'teacherC',
        'name': 'Ethical Controversies surrounding gene editing',
        'issue_topic': 'Should gene editing of human embryos be banned?',
        'article_content': 'CRISPR Technological breakthroughs have made gene editing more precise and easier. This technology holds the promise of curing hereditary diseases and benefiting countless patients. However, its application to human embryos could spark ethical controversies surrounding custom-made babies and exacerbate social inequality. Many scientists are calling for a halt to gene editing of human germ cells until relevant laws and ethical guidelines are in place to avoid irreversible consequences.',
        'start_date': START_DATE,
        'end_date': END_DATE,
    },
    {
        'created_by': 'teacherC',
        'name': 'Feasibility of basic income',
        'issue_topic': 'Should the government implement an unconditional basic income (UBI)?',
        'article_content': "In response to the employment impact of automation, unconditional basic income (UBI) has been proposed as a social safety net. Supporters argue that UBI can guarantee people's basic right to survival, reduce income inequality, and encourage people to pursue more meaningful work. Opponents worry that UBI will place a heavy burden on national finances and may reduce people's willingness to work. Currently, only small-scale experiments are being conducted in various countries, and its actual effectiveness and impact remain to be further verified.",
        'start_date': START_DATE,
        'end_date': END_DATE,
    },
]
