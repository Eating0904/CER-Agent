...
from seeder.prod_data.lab_data import LABS
from seeder.prod_data.mind_map_template_data import TEMPLATES
from seeder.prod_data.password_config import get_password
from seeder.prod_data.user_data import USERS
